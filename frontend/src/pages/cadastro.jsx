  ...
  return (
    <div className="cadastro-container">
      <div className="cadastro-form-container">
        ...
        {error && <div className="cadastro-error-message">{error}</div>}
        <form onSubmit={handleSubmit}>
          <div className="cadastro-name-fields">
            <input
              type="text"
              name="nome"
              placeholder="Nome"
      ...
      <div className="cadastro-side-text">
        <div className="cadastro-letter2">
          <span className="cadastro-letter">A</span>
          <span>mazônia</span>
        </div>
        <div className="cadastro-letter2">
          <span className="cadastro-letter">I</span>
          <span>nteligente com</span>
        </div>
        <div className="cadastro-letter2">
          <span className="cadastro-letter">R</span>
